...
vim.keymap.set("n", "<leader>init", "<cmd>e ~/.config/nvim/init.lua<CR>")
...
vim.keymap.set('n', '<leader>kb', require('telescope.builtin').keymaps, {desc = 'Show [K]ey [B]inds'})
vim.keymap.set('n', '<leader>sf', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' })

require('nvim-treesitter.configs').setup {
  ensure_installed = { 'php', 'c', 'cpp', 'lua','html', 'javascript','vimdoc', 'vim', 'java', 'kotlin' },
